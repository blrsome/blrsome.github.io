                    ...
                    <div id=':fixed' class='col-[2] grid transition-all duration-[375ms]'>
                        ...
                        <SubCaption id='sub'
                            class='relative grid sm:col-[1/3] md:col-[2] row-[3/4]'>
                                <span id='sub:content'
                                    class='px-3 inset-x-0 -bottom-[1px] w-full h-0 rounded-t text-[var(--on-secondary-container)] bg-[var(--secondary-container)] absolute text-sm truncate transition-all supports-[backdrop-filter]:backdrop-blur-sm select-none'>
                                </span>
                        </SubCaption>
                    </div>
                </div>
