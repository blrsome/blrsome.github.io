!(function () {
    ...
    const P = {
            ...
            RadioButton(t) {
                ...
                (t.a === t.b && a.setAttribute('checked', !0)),
                l = P.Create('label', {
            ...
            ToggleButton(t) {
                ...
                (t.state && a.setAttribute('checked', !0)),
                l = P.Create('label', {
                    text: t.label,
                    for: `${t.section}:${t.a}`,
                    'class': [
    ...
    Object.entries({
        ...
        P.RadioButton({
            section: 'p\:theme',
            a: n,
            b: Reflect.get(Documentation.Data, 'theme') || 'auto',
            dependence: 'theme',
            translatePath: t,
            changeCallback: e => Reflect.set(Documentation.Data, 'theme', e.target.value),
        })),
    Translate.Languages.forEach(t =>
        P.RadioButton({
            ...
            changeCallback: e => Reflect.set(Translate, 'Language', e.target.value),
        })),
    Object.entries({
        seasonal: {
            name: Translate.Path('experimental/seasonal'),
            toggle: d => Reflect.set(Documentation.Data, 'seasonal', d)
        }
    }).forEach(([n, t]) =>
        P.ToggleButton({
            section: 'p\:exp',
            dependence: n,
            label: t.name,
            state: Reflect.get(Documentation.Data, 'seasonal') || !1,
